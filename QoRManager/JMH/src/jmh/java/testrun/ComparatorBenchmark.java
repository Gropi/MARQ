...
public class ComparatorBenchmark {
    ...
    private void EConstraintBenchmark(Blackhole blackhole) {
        ...
        alternativesInBoundary = m_BoundryFilter.filter(paretoOptima, m_Parameter.get(parameterCount), m_Criteria.get(parameterCount));

        for (IWeight candidate : alternativesInBoundary) {
